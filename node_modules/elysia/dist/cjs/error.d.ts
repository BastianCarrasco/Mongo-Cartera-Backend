...
export declare class ElysiaCustomStatusResponse<const in out Code extends number | keyof StatusMap, in out T = Code extends keyof InvertedStatusMap ? InvertedStatusMap[Code] : Code, const in out Status extends Code extends keyof StatusMap ? StatusMap[Code] : Code = Code extends keyof StatusMap ? StatusMap[Code] : Code> {
    code: Status;
    response: T;
...
export declare class ValidationError extends Error {
    ...
    code: string;
    status: number;
    constructor(type: string, validator: TSchema | TypeCheck<any> | ElysiaTypeCheck<any>, value: unknown, errors?: ValueErrorIterator);
    get all(): ({
        summary: undefined;
    } | {
        summary: string;
