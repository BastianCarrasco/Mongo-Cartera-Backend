...
import type { LifeCycleStore, MaybeArray, InputSchema, LifeCycleType, HookContainer, Replace, SchemaValidator, AnyLocalHook, SSEPayload } from './types';
 ...
 *   }
 */
export declare const sse: (payload: string | SSEPayload) => SSEPayload & {
    toStream(): string;
};
export {};
